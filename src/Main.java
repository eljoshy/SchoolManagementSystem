...
public class Main {
    public static void main(String[] args) {
        ...
        Estudiante estudiante1 = new Estudiante(1, "Manuel", "Alvarez", "2005-20-6", "matriculado");
        Estudiante estudiante2 = new Estudiante(2, "che", "Garrido", "2005-01-17", "matriculado");
